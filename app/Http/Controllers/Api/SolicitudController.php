...
class SolicitudController extends Controller
{
    ...
    public function completedA()
    {
        return Mecanica::where('state', 'completado')
            ->with('user')
            ->get();
    }
    ...
    public function saveRequestA(Request $request)
    {
    ...
    {
        error_log("Solicitando completar",null);
        // Buscar Mecanica y validar si existe
        $mecanica = Mecanica::find($id);
        error_log(Mecanica::find($id),null);
        if (!$mecanica) {
            return response()->json([
                'success' => false,
                'message' => 'La Mecanica no existe'
