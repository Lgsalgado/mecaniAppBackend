...
Route::group([
    ...
    Route::post('/request/approve/{id}', [SolicitudController::class, 'approveRequest']);
    Route::post('/request/reject/{id}', [SolicitudController::class, 'rejectRequest']);
    Route::get('/user/request', [SolicitudController::class, '']);
});
